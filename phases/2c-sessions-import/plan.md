# Phase 2C — safe sessions, import, and provenance
...
### 2C.1 Define the session format
...
### 2C.2 Define asset and provenance records
...
### 2C.3 Discover source files safely
...
### 2C.4 Implement bounded streaming ingest
...
### 2C.5 Add import batches and resumability
...
### 2C.6 Define the thumbnail handoff
